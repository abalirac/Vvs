...
public class Datagen {
    ...
    void onActivate() throws DuplicateInstanceException, IncorrectPasswordException, InstanceNotFoundException, IllegalArgumentException, TimeExpiredException{
		try {
			this.cargado = false;
	    	...
	    	Product product1 = productService.insertAd(userProfile.getUserProfileId(), 1L, 
					"Audi A1", "Coche en muy buenas condiciones", 240, 30, "envío por trasporte urgente");
	    	
	    	productService.insertAd(userProfile.getUserProfileId(), 1L, 
					"Audi A2", "Coche en muy buenas condiciones", 240, 40, "envío por trasporte urgente");
	    	
	    	productService.insertAd(userProfile.getUserProfileId(), 1L, 
					"Audi A3", "Coche en muy buenas condiciones", 500, 1, "envío por trasporte urgente");
	    	
	    	productService.insertAd(userProfile.getUserProfileId(), 1L, 
					"Audi A4", "Coche en muy buenas condiciones", 240, 30, "envío por trasporte urgente");
	    	
	    	productService.insertAd(userProfile.getUserProfileId(), 1L, 
					"Audi A5", "Coche en muy buenas condiciones", 5, 10, "envío por trasporte urgente");
	    	
	    	productService.insertAd(userProfile2.getUserProfileId(), 2L, 
					"PolyStation4", "Consola china cutre", 240, 2, "envío por barco a remo");
