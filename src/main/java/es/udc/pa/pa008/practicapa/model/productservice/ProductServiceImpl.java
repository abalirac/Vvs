...
public class ProductServiceImpl implements ProductService {
    ...
    public Product insertAd(Long userProfileId, Long categoryId, String productName, String description, int duration,
            double startingPrice, String shippingInfo) throws InstanceNotFoundException {

        UserProfile userProfile = userProfileDao.find(userProfileId);
        Category category = categoryDao.find(categoryId);

        Product product = new Product(userProfile, category, productName, description, duration, startingPrice,
                shippingInfo);
    ...
    public ProductBlock findByKeywords(String keywords, Long categoryId, int startIndex, int count)
         ...
         * products above the specified range.
         */
