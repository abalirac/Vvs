...
public class BidServiceTest {
	...
	public void testMakeBidUnderInitialValue() throws DuplicateInstanceException, InstanceNotFoundException, TimeExpiredException{
	...
	public void testMakeBidHigher() throws DuplicateInstanceException, InstanceNotFoundException, TimeExpiredException{
		...
		Product product = productService.insertAd(userProfile.getUserProfileId(), category.getCategoryId(), 
				"Audi A4", "Coche en muy buenas condiciones", 24000, 30, "envío por trasporte urgente");
	...
	@Test(expected = LowBidValueException.class)
	public void testMakeBidUnderAuctionValue() throws DuplicateInstanceException, InstanceNotFoundException, TimeExpiredException{
    ...
    public void testmakeBidTimeExpired() throws InstanceNotFoundException, DuplicateInstanceException, TimeExpiredException {
		...
		Product product = productService.insertAd(userProfile.getUserProfileId(), category.getCategoryId(), 
				"Audi A4", "Coche en muy buenas condiciones", -200, 30, "envío por trasporte urgente");
	...
	@Test
	public void testFindBidsByUser() throws DuplicateInstanceException, InstanceNotFoundException, TimeExpiredException{
		...
		Product product = productService.insertAd(userProfile.getUserProfileId(), category.getCategoryId(), 
				"Audi A4", "Coche en muy buenas condiciones", 10, 10, "envío por trasporte urgente");
	...
	@Test
	public void testMakeBidOtherUser() throws DuplicateInstanceException, InstanceNotFoundException, IllegalArgumentException, TimeExpiredException{
	...
	public void testMakeBidMinValue() throws DuplicateInstanceException, InstanceNotFoundException, TimeExpiredException{
		...
		Product product = productService.insertAd(userProfile.getUserProfileId(), category.getCategoryId(), 
				"Audi A4", "Coche en muy buenas condiciones", 240, 10, "envío por trasporte urgente");
		
		bidService.makeBid(userProfile.getUserProfileId(), product.getProductId(), 10);
		
		bidService.makeBid(userProfile2.getUserProfileId(), product.getProductId(), 11);
		
		bidService.makeBid(userProfile.getUserProfileId(), product.getProductId(), 12);
		
		bidService.makeBid(userProfile.getUserProfileId(), product.getProductId(), 14);
		
		bidService.makeBid(userProfile2.getUserProfileId(), product.getProductId(), 13);
		
		bidService.makeBid(userProfile2.getUserProfileId(), product.getProductId(), 15);
		
		bidService.makeBid(userProfile.getUserProfileId(), product.getProductId(), 15);
