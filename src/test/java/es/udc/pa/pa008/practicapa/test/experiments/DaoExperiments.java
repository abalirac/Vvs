package es.udc.pa.pa008.practicapa.test.experiments;
...
import es.udc.pa.pa008.practicapa.model.userprofile.UserProfileDaoHibernate;
import es.udc.pa.pa008.practicapa.model.userservice.util.PasswordEncrypter;
...
public class DaoExperiments {
    ...
    public static void main(String[] args) {
        ...
        userProfileDaoHibernate.setSessionFactory(HibernateUtil.getSessionFactory());
        ...
        try {
            ...
            // Register user.
            UserProfile userProfile = new UserProfile("daoUser", PasswordEncrypter.crypt("userPassword"), "name",
            ...
            System.out.println("User with userId '" + userId + "' has been retrieved");
            System.out.println(userProfile);
